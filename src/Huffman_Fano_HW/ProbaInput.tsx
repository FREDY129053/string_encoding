    ...
    <div className="flex flex-col items-center gap-6 mt-6">
      ...
      <div className="relative z-0 w-64 mb-5 group lg:mb-0 mx-auto">
        ...
        <label
          ...
          // className="peer-focus:font-medium absolute text-sm text-gray-600 duration-300 transform -translate-y-6 scale-75 top-3 left-0 w-full peer-focus:text-blue-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
        ...
        >
          Enter length of the sequences(max 5)
        </label>
      </div>
